...
@section('content')
    <main>
        <div class="head-title">
            <div class="left">
                <h1>Produk Populer Management</h1>
                <ul class="breadcrumb">
                    <li>
                        <a href="#">Dashboard</a>
                    </li>
                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('dashboard.popular.post') }}" method="post"
                                    ...
                                    <div class="mb-2 row">
                                        <div class="col-12">
                                            <label for="name">Nama Event Populer</label>
                                            <input type="text" name="name" placeholder="Masukan nama event populer"
            ...
            const appendHtml = `
                <div class="modal fade" id="modalEdit" tabindex="-1" aria-hidden="true">
                    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h5 class="modal-title">Edit Populer</h5>
                            ...
                            <div class="modal-body">
                                <form id="editProductForm" action="${rowData.urlEdit}" method="post">
                                    ...
                                    @method("PUT")
                                    <div class="row mb-3">
                                        <label for="editSku" class="col-sm-4 col-form-label">SKU Produk</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="editSku" value="${rowData.sku || ''}" disabled>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="populerName" class="col-sm-4 col-form-label">Populer Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="populerName" name="name" value="${rowData.name || ''}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
