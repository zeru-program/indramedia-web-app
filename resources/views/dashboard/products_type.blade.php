                        ...
                        <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form action="{{ route('dashboard.products.type.post') }}" method="post"
                                        enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-2 row">
                                        <div class="col-12">
                                            <label for="name">ID Type Produk</label>
                                    ...
                                    <div class="mb-2 row">
                                        <div class="col-12">
                                            <label for="name">Nama Type Produk</label>
                                            <input type="text" name="name" placeholder="Masukan nama type"
                                            class="form-control" required>
                                        </div>
                                    </div>
                                    <div class="mb-2 row">
    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#myTable').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route('dashboard.products.type') }}"
                },
                columns: [{
                        data: 'DT_RowIndex',
                        orderable: false,
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="editProductForm" action="${rowData.urlEdit}" method="post">
                                    ...
                                    @method("PUT")
                                    <div class="row mb-3">
                                        <label for="editId" class="col-sm-4 col-form-label">Type ID</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="editId" value="${rowData.type_id || ''}" disabled>
                                        </div>
                                    </div>
                                    <div class="row mb-3">
                                        <label for="typeName" class="col-sm-4 col-form-label">Type Name</label>
                                        <div class="col-sm-8">
                                            <input type="text" class="form-control" id="typeName" name="name" value="${rowData.type_name || ''}">
                                        </div>
                                    </div>
                                    <div class="row mb-3">
