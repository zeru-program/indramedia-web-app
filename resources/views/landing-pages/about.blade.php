      ...
      <div class="container">
        <div class="row">
          <div class="col-8 mx-auto text-center">
            <h2 class="mb-3 text-capitalize fw-bold wow fadeInUp" data-aos-delay='1.5s'>Tentang Kami</h2>
            <ul class="list-inline breadcrumbs text-capitalize wow fadeInUp" data-aos-delay='1.5s' style="font-weight:500">
              <li class="list-inline-item"><a href="{{ route('home') }}">Home</a>
              </li>
              <li class="list-inline-item">/ &nbsp; <a href="{{ route('tentang-kami') }}">Tentang Kami</a>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div class="row justify-content-center align-items-center">
          <div class="col-lg-7">
            <div class="section-title">
              <p class="text-primary text-uppercase fw-bold mb-3 wow fadeInUp" data-aos-delay='1.5s'>Tentang Indramedia</p>
              <h2 class="h1 mb-4 fw-bold wow fadeInUp" data-aos-delay='1.5s'>Solusi Digital <br> Terbaik untuk Kebutuhan Anda</h2>
              <div class="content pe-0 pe-lg-5 wow fadeInUp" data-aos-delay='1.5s'>
                <p>Indramedia hadir untuk menyediakan produk digital terbaik yang dirancang khusus untuk mendukung kebutuhan Anda. Kami berkomitmen memberikan layanan berkualitas tinggi, solusi inovatif, dan pengalaman yang tak tertandingi.</p>
                <p>Mulai dari solusi teknologi hingga layanan digital terkini, kami memastikan kebutuhan bisnis dan pribadi Anda terpenuhi dengan cara yang paling efisien dan efektif.</p>    
              </div>
            </div>
          </div>
          <div class="col-lg-4 mt-5 mt-lg-0 wow fadeInUp" data-aos-delay='1.5s'>
            <img loading="lazy" decoding="async" src="images/new/logo-1.png" alt="Business Loans &lt;br&gt; For Daily Expenses" class="rounded w-100">
          </div>
        </div>
      </div>
    </section>
      ...
      <div class="container">
        <div class="row justify-content-around">
          <div class="col-lg-5">
            ...
            <p class="lead">Kami berkomitmen untuk membangun masa depan yang lebih baik dengan inovasi dan dedikasi. Visi kami adalah menciptakan solusi yang memajukan kehidupan masyarakat melalui teknologi yang berkelanjutan dan inklusif.</p>
            <div class="content">Dengan fokus pada keberlanjutan dan kesejahteraan, kami berupaya untuk memberikan dampak positif dalam setiap aspek yang kami kerjakan. Kami percaya bahwa setiap langkah kecil yang diambil dengan niat baik akan menciptakan perubahan besar yang bermanfaat bagi generasi mendatang.</div>
          </div>
          <div class="col-lg-5">
            <div class="section-title">
              <p class="text-primary text-uppercase fw-bold mb-3"></p>
            ...
            <p class="lead">Kami berkomitmen untuk menjadi mitra terpercaya yang mendukung pertumbuhan dan keberhasilan semua pihak yang kami layani. Misi kami adalah untuk menyatukan potensi terbaik dalam mencapai tujuan bersama.</p>
            <div class="content">
              <ul>
                <li>Menjalin kemitraan yang kokoh dengan berbagai pihak untuk menciptakan solusi bersama.</li>
                <li>Mendorong inovasi melalui pendekatan berbasis data dan riset yang mendalam.</li>
                <li>Meningkatkan kualitas hidup masyarakat dengan menyediakan akses terhadap teknologi dan pendidikan yang relevan.</li>
              </ul>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
            ...
            <h3 class="fw-bold">Mudah Digunakan</h3>
            <p class="px-lg-5">Antarmuka yang ramah pengguna dan mudah dipahami, memungkinkan Anda untuk memulai dengan cepat tanpa kerumitan.</p>
          </div>
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
            <div class="icon icon-lg bg-transparent mb-4"><i class="fas bi-cash text-primary"></i>
            </div>
            <h3 class="fw-bold">Harga Bersahabat</h3>
            <p class="px-lg-5">Nikmati layanan berkualitas dengan harga yang terjangkau, memberikan nilai lebih untuk setiap investasi Anda.</p>
          </div>
          <div class="col-lg-4 col-md-6 mb-5 mb-lg-0 text-center icon-box-item">
            <div class="icon icon-lg bg-transparent mb-4"><i class="fas bi-search text-primary"></i>
            </div>
            <h3 class="fw-bold">Mudah Dicari</h3>
            <p class="px-lg-5">Kami hadir di berbagai platform, memudahkan Anda untuk menemukan kami kapan saja dan di mana saja</p>
          </div>
        </div>
      </div>
    </section>
        ...
        <div class="row align-items-center">
            ...
            <div class="row position-relative gy-4">
              <div class="icon-box-item col-md-6">
                <div class="block bg-white">
                  ...
                  <h3 class="mb-3">Otentik</h3>
                  <p class="mb-0">Kami selalu menghadirkan solusi yang asli dan terpercaya, dengan menjaga kualitas dan integritas setiap langkah yang diambil.</p>
                </div>
              </div>
              <div class="icon-box-item col-md-6">
                <div class="block bg-white">
                  <div class="icon rounded-number">02</div>
                  <h3 class="mb-3">Empati</h3>
                  <p class="mb-0">Kami mendengarkan dan memahami kebutuhan Anda dengan penuh perhatian, memastikan setiap solusi yang kami tawarkan tepat sasaran</p>
                </div>
              </div>
              <div class="icon-box-item col-md-6">
                <div class="block bg-white">
                  <div class="icon rounded-number">03</div>
                  <h3 class="mb-3">Selalu Berkembang</h3>
                  <p class="mb-0">Kami berkomitmen untuk terus berkembang dan meningkatkan kualitas layanan agar dapat memenuhi harapan Anda yang terus berubah.</p>
                </div>
              </div>
              <div class="icon-box-item col-md-6">
                <div class="block bg-white">
                  <div class="icon rounded-number">04</div>
                  <h3 class="mb-3">Berfokus pada Pengguna</h3>
                  <p class="mb-0">Kami selalu menempatkan pengguna sebagai prioritas utama dalam setiap keputusan yang kami buat, demi kenyamanan dan kepuasan Anda.</p>
                </div>
              </div>
              <div class="has-shapes">
          ...
          <div class="col-lg-6 mt-5 mt-lg-0">
            <div class="section-title ps-0 ps-lg-5">
              <p class="text-primary text-uppercase fw-bold mb-3">Indramedia Digital</p>
              <h2 class="h1 fw-bold">Nilai Dan Tujuan</h2>
              <div class="content">
                <p>Kami berkomitmen untuk memberikan solusi yang inovatif, efektif, dan selalu relevan dengan kebutuhan pasar. Nilai-nilai inti kami mencerminkan dedikasi kami untuk menciptakan dampak positif bagi masyarakat, melalui layanan yang berkualitas dan tepat sasaran.</p>
                <p>Melalui pendekatan yang berfokus pada pengguna, kami tidak hanya memberikan solusi, tetapi juga pengalaman yang memuaskan. Kami terus berupaya untuk meningkatkan kemampuan dan memperluas wawasan agar dapat memberikan pelayanan terbaik bagi Anda.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-12">
            <div class="section-title text-center">
              <p class="text-primary text-uppercase fw-bold mb-3">struktur</p>
              <h1 class="fw-bold">Tim Kami</h1>
              <p class="mb-0">Kami adalah tim yang berdedikasi untuk memberikan yang terbaik.<br> Kami bekerja bersama untuk mencapai tujuan yang lebih besar</p>
            </div>
          </div>
        </div>
        <div class="row justify-content-center position-relative">
          <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
            <div class="card bg-transparent border-0 text-center">
              <div class="card-img">
                <img loading="lazy" decoding="async" src="images/about/team-3.jpg" alt="Scarlet Pena" class="rounded w-100" width="300" height="332">
          ...
          <div class="col-xl-3 col-lg-4 col-md-6 mt-4">
            <div class="card bg-transparent border-0 text-center">
              <div class="card-img">
                <img loading="lazy" decoding="async" src="images/about/team-3.jpg" alt="Claire Simmmons" class="rounded w-100" width="300" height="333">
                <ul class="card-social list-inline">
                  <li class="list-inline-item"><a class="facebook" href="#"><i class="fab fa-facebook"></i></a>
                  </li>
                  <li class="list-inline-item"><a class="twitter" href="#"><i class="fab fa-twitter"></i></a>
