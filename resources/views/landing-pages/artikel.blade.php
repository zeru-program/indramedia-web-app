          ...
          <div class="container">
              <div class="row">
                  <div class="col-8 mx-auto text-center">
                      <h2 class="mb-3 text-capitalize fw-bold">Artikel</h2>
        ...
        <section class="container">
              ...
              <div class="accordion-item">
                ...
                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                  <div class="accordion-body">
                      <form method="GET" action="{{ route('artikel') }}" class="w-100 d-flex px-2">
                          {{-- @csrf --}}
                          <div class="w-100">
                            <div class="row align-items-center">
                              <div class="col-12 mb-3">
                                <label for="nama_artikel">Cari Artikel</label>
                                <input type="text" name="q" value="{{ request('q') }}" class="form-control" placeholder="masukan nama artikel.." id="searchInput">
                              </div>
                            </div>
                            {{-- <div class="row align-items-center">
                              <div class="col-12 mb-3">
            ...
            <div class="d-flex contain-artikel mt-3 flex-wrap gap-2" id="searchResults"> 
                ...
                <div class="box-artikel rounded-2 shadow-sm mb-2" onclick="window.location.href = '{{ route('artikel.detail', $blog->slug) }}'" style="height: 300px">
                    ...
                    <div class="m-2">
                      <h6 class="fw-bold mb-0">{{ $blog->title }}</h6>
                      <p class="mb-0 desc-short-blog">{{ $blog->content }}</p>
                      <div class="d-flex color-ac gap-3 mt-2">
                          <div class="gap-2 d-flex box-supporter">
                              <i class="bi-person-fill mb-0"></i>
                              <span class="mb-0">{{ $blog->created_by }}</span>
                          </div>
                          <div class="gap-2 d-flex box-supporter">
         ...
         function filter() {
          ...
          success: function (response) {
              ...
              response.items.forEach(element => {
                  ...
                  const newEl = `
                  <div class="box-artikel rounded-2 shadow-sm mb-2" onclick="window.location.href = '/artikel/${element.title}'">
                    ...
                    <div class="m-2">
                      <h6 class="fw-bold mb-0">${element.title}</h6>
                      <p class="mb-0 desc-short-blog">${element.content}</p>
                      <div class="d-flex color-ac gap-3 mt-2">
                          <div class="gap-2 d-flex box-supporter">
                              <i class="bi-person-fill mb-0"></i>
                              <span class="mb-0">${element.created_by}</span>
                          </div>
                          <div class="gap-2 d-flex box-supporter">
                              <i class="bi-calendar"></i>
                              <span>${element.created_by.slice(0, 10)}</span>
                          </div>
                      </div>
                    </div>
                </div>
              ...
              <div class="w-100 d-flex flex-wrap align-items-center">
                ...
                <h4>Ups, Artikel tidak Tersedia.</h4>
              </div>
              `;
