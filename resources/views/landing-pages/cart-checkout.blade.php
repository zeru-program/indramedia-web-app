    ...
    <main class="fh-page py-5 text-dark bg-light">
        ...
        <section class="page-header bg-tertiary">
            <div class="container">
                <div class="row">
                    <div class="col-8 mx-auto text-center">
                        <h2 class="mb-3 text-capitalize fw-bold">Keranjang Belanja</h2>
                        <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                            <li class="list-inline-item"><a href="{{ route('home') }}">Home</a>
                            </li>
                            <li class="list-inline-item">/ &nbsp; <a href="{{ route('cart.checkout') }}">Keranjang
                                    Belanja</a>
                            </li>
                        </ul>
                    </div>
            ...
            <div class="has-shapes">
                <svg class="shape shape-left text-gray" viewBox="0 0 192 752" fill="none"
                ...
                <svg class="shape shape-right text-gray" viewBox="0 0 731 746" fill="none"
                    xmlns="http://www.w3.org/2000/svg">
                    <path
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-lg-12">
                                    <div class="contact-form">
                                        <div>
                                            <table id="myTable" class="table-admin w-100 mt-3 mb-3 rounded-sm">
                                                <thead>
                                                    <tr>
                                                        <th>#</th>
                                                        <th>Nama Produk</th>
