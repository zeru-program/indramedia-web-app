...
@section('content')
            ...
            <div class="container">
                <div class="row">
                    <div class="col-8 mx-auto text-center">
                        <h2 class="mb-3 text-capitalize fw-bold">Hubungi Kami</h2>
                        <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                            <li class="list-inline-item"><a href="{{ route('home') }}">Home</a>
                            </li>
                            <li class="list-inline-item">/ &nbsp; <a href="{{ route('hubungi-kami') }}">Hubungi Kami</a>
                            </li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row justify-content-center align-items-center">
                    <div class="col-lg-6">
                        <div class="section-title text-center">
                            ...
                            <h1 class="fw-bold">Mari Terhubung Dengan Kami</h1>
                            <p>Jika Anda memiliki pertanyaan atau ingin berdiskusi lebih lanjut, kami siap membantu. Jangan ragu untuk menghubungi kami melalui form atau kontak di bawah ini.</p>
                        </div>
                    </div>
                    <div class="col-lg-10">
                        <div class="shadow rounded p-5 bg-white">
                            ...
                            <div class="row mt-3">
                                <div class="col-12 mb-4">
                                    <h4 class="fw-bold">Tinggalkan Pesan</h4>
                                </div>
                                <div class="col-lg-6">
                                    <div class="contact-form">
                                        <form   onsubmit="return false;">
                                            ...
                                            <div class="form-group mb-4 pb-2">
                                                ...
                                                <textarea class="form-control shadow-none" id="contact_message" rows="3"></textarea>
                                            </div>
                                            <button class="btn btn-primary w-100" type="button" onclick="redirectToWhatsApp()">Send Message</button>
                                        </form>
                                    </div>
                                </div>
                                    ...
                                    <div class="contact-info">
                                        ...
                                        <div class="block">
                                            <ul class="list-unstyled list-inline my-4 social-icons">
                                                <li class="list-inline-item me-3"><a title="Explorer Facebook Profile" class="text-black" href="https://www.instagram.com/endezkitchen/"><i class="fab fa-instagram"></i></a>
                                                </li>
                                                <li class="list-inline-item me-3"><a title="Explorer Twitter Profile" class="text-black" href="https://www.youtube.com/@indramediadigital7749"><i class="fab fa-youtube"></i></a>
                                                </li>
                                                <li class="list-inline-item me-3"><a title="Explorer Instagram Profile" class="text-black" href="https://www.instagram.com/bukusekolahan.id"><i class="fab fa-instagram"></i></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
    ...
    <script>
        function redirectToWhatsApp() {
            ...
            // Nomor WhatsApp tujuan (gunakan nomor Anda di sini)
            const phoneNumber = '6285746214441';

            // Format pesan
            const whatsappMessage = `Hallo, Nama saya ${encodeURIComponent(name)}. 
