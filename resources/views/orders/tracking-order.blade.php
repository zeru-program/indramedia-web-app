          ...
          <div class="container">
              <div class="row">
                  <div class="col-8 mx-auto text-center">
                      <h2 class="mb-3 text-capitalize fw-bold">Lacak Pesanan</h2>
                      <ul class="list-inline breadcrumbs text-capitalize" style="font-weight:500">
                          <li class="list-inline-item"><a href="{{ route('home') }}">Home</a>
                          </li>
                          <li class="list-inline-item">/ &nbsp; <a href="{{ route('lacak-pesanan') }}">Lacak Pesanan</a>
                          </li>
                      </ul>
                  </div>
              </div>
              ...
              <div class="row justify-content-center align-items-center">
                  <div class="col-lg-6">
                      <div class="section-title text-center">
                          <p class="text-primary text-uppercase fw-bold mb-3">Pesanan</p>
                          <h1 class="fw-bold">Ayo Pantau Pesanan Mu</h1>
                      ...
                      <div class="shadow rounded p-5 bg-white">
                          <div class="row mt-3">
                              <div class="col-12 mb-4">
                                  <h4 class="fw-bold">Form pencarian</h4>
                              </div>
                              <div class="col-lg-12">
                                  <div class="contact-form">
                                      <form   onsubmit="return false;">
                                          <div class="form-group mb-4 pb-2">
                                              ...
                                              <input type="text" class="form-control shadow-none" id="order_id">
                                          </div>
                                          <button class="btn btn-primary w-100" type="button" onclick="handleTrack()">Lacak</button>
                                      </form>
                                  </div>
                              </div>
                          </div>
