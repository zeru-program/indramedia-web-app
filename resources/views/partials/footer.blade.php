   <footer class="bg-dark text-light">
        <div class="container py-5">
          <div class="row py-3">
            ...
            <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
              <h6 class="text-uppercase font-weight-bold mb-2">About</h6>
            ...
            <div class="col-lg-2 col-md-6 mb-4 mb-lg-0">
              ...
              <ul class="list-unstyled mb-0">
                ...
                <li class="mb-2"><a href="#" class="text-light">Our Products</a></li>
              </ul>
            </div>
        ...
        <div class="bg-muted py-2">
          <div class="container text-center">
            <p class="text-light mb-0 py-2">&copy; 2024-2025 Indramedia All rights reserved.</p>
