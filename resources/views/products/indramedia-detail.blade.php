    ...
    <section class="align-items-center d-flex flex-column pt-5">
        <div class="container d-flex flex-column">
            ...
            <div class="">
                   ...
                   <form action="{{ route('produk.indramedia.create') }}" enctype='multipart/form-data' method="POST" class="mt-2">
                      @csrf
                  ...
                  <div class="row col-md-12">
                    ...
                    @if ($data->is_file == 1)
                      ...
                      <div class="mb-2 col-md-6">
                          <label for="order_qty">Jumlah pesanan</label>
                          <input type="number" name="order_qty" min="1" placeholder="Masukan jumlah pesanan" class="form-control">
